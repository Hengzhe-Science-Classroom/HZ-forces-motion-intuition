// === Forces & Motion Intuition - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('forces-motion-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('forces-motion-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
